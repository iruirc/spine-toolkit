...
- **Done** — final report `Done.md` for the epic:
  ...
  - When `Done.md` already exists — a redo, a restart, a continue after a hand-back — every claim in it is checked against the current artifacts and `git log` before it is kept.
