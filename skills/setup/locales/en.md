...
No platform plugin is installed. spine-toolkit needs one to know your stack — install one (spine-platform-swift for Swift, spine-platform-kotlin for Kotlin, or another platform plugin) and run `/setup` again.
