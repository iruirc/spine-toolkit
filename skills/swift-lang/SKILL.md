...
```
1. Locate CLAUDE-spine-toolkit.md in the current project root.
...
- CLAUDE-spine-toolkit.md missing → key `error_no_toolkit_file`.
...
- Does NOT touch any other CLAUDE-spine-toolkit.md section.
