...
description: |
  ...
  Use when (en): "move task to DONE", "move task to ACTIVE", "task 038 to DONE", "step 2 of epic 052 to DONE", "step address-form of task 052 to DEFERRED"
  Use when (ru): "перемести задачу в DONE", "move task to ACTIVE", "задачу 038 в DONE", "2.step задачи 052 в DONE", "шаг 1 эпика 052 в BLOCKED", "шаг address-form задачи 052 в DEFERRED"
---
...
Step status changes (field update) cover variants like: "step 2 of epic 052 to DONE", "step address-form of epic 052 to DEFERRED".
...
1. **Locate the step folder** — find the parent epic first, then the `.step` inside it.
   Path example: `Tasks/ACTIVE/052-checkout-redesign/2.step/`.
