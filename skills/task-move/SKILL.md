---
name: task-move
description: "Moves a root task between status folders (physical mv) or changes the [STATUS] field of a step task inside an epic. Use when: user says 'перемести задачу в DONE', 'move task to ACTIVE', 'задачу 038 в DONE', '2.step задачи 052 в DONE', 'шаг 1 эпика 052 в BLOCKED'."
---
...
- "2.step задачи 052 в DONE", "шаг 2 эпика 052 в DONE"
- "1.step задачи 052 в BLOCKED"
- "шаг address-form задачи 052 в DEFERRED"
...
5. **Report** the change: `Tasks/.../052/2.step [STATUS]: <old> → <new>`.
